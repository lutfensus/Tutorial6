...
LibraryMedia[] mediaArray = new LibraryMedia[2];
        mediaArray[0] = book1;
// Book object stored as LibraryMedia
        mediaArray[1] = movie1;
// Movie object stored as LibraryMedia
...
// Demonstrating borrowing and returning operations
        ...
        book1.borrow();
// Borrowing the book
// Attempting to borrow again – should show that
...
// Method specific to Movie// Demonstrating casting to call type-specific methods via base
        class reference
System.out.println("\n===== TYPE CASTING =====");
        for (LibraryMedia media : mediaArray) {
